...
<body>
  ...
  <div class="container">
    <div class="row">
        ...
        <form action="new1.php" method="post">
          <?php while ($agent = mysqli_fetch_assoc($data)) { ?>
            <tr>
              ...
              <td><img src="img/labs/<?php echo $agent["image"]; ?>" style="width: 80px;"></td>
              ...
              <td>
                ...
                <a class="btn btn-danger" href="cart_lab.php?id=<?php echo $agent["id"]; ?>&action=restore">Delete Form cart</a>
              </td>
            </tr>
          <?php } ?>
          <tr>
      ...
      <a class="btn btn-light btn btn-outline-primary" href="labs.php">Back</a>
