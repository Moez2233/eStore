...
if (isset($_POST["model_id"])) {
  ...
  mobiles_new($filename,$_POST["model_id"], $_POST["color_id"],$_POST["price"],$_POST["year_id"]);
}
  ...
  <body>
    ...
    <div class="container" style="width:700px";>
      <div class="row" style="margin-top:50px";>
        <h1 class="display-1">New Mobiles</h1>
        <form action="mobiles_new.php" method="post" enctype="multipart/form-data" style="border:3px solid#f1f1f1";>
